...
- ⚠️ Manual chaining of commands
- ⚠️ No built-in workflow DSL
- ⚠️ No workflow templates

**State management:**

- ⚠️ No workflow state persistence
- ⚠️ No checkpoint/resume
- ⚠️ No rollback on failure

**Scheduling:**

- ⚠️ External cron/scheduler needed
- ⚠️ No built-in scheduling
- ⚠️ No recurring workflows
