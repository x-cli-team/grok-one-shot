...
> **⚠️ PARITY GAP**: Grok One-Shot does not currently implement the Agent Skills system described in this document. This is a Claude Code feature planned for future implementation.
