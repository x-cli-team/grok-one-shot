...
Extended slash command system for advanced session control, history management, and workflow automation.
...
- **Q3-Q4 2025:** Sprint 27-30 - Workflow automation and advanced features

**Priority:** P2 - UX enhancement

## Current Commands

See [Slash Commands](./slash-commands.md) for currently available commands.

---

**Check back Q3 2025 for advanced slash commands.**
